...
const REMIX_IDEAS = [
    "to create a poster for your favorite book.",
    "to turn your pet into a movie star.",
    "to design a poster for a sci-fi movie.",
    "to imagine yourself in a historical drama.",
    "to generate a custom video game cover.",
    "to create a vintage horror movie poster.",
];
